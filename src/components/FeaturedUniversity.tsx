...
const FeaturedUniversity = () => {
  ...
  return (
    <section ref={sectionRef} className="section-container">
      <Link to="/university-details/13" className="block">
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl overflow-hidden shadow-smooth-lg section-animate hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="p-8 md:p-12 text-white">
              ...
              <div className="flex flex-wrap">
                <ShimmerButton
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.location.href = "/university-details/13";
                  }}
                >
                  View Details
                </ShimmerButton>
