...
const WhatsAppButton = ({ 
  phoneNumber, 
  message = "Hello, I'm interested in MBBS Abroad Journey. Can you provide more information?" 
}: WhatsAppButtonProps) => {
  ...
  return (
    <a
      ...
      className={`fixed right-6 bottom-6 z-50 flex items-center justify-center w-16 h-16 bg-green-500 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 ${
